...
function changeLinkText(lnk) {
    ...
    if (lnk == 'home'){
        ...
        document.getElementById('divRight').innerHTML = "Home link clicked. Default txt displayed.";
        ...
        document.getElementById('divRight').style.display = "Default description for Class Excersice Link";
        ...
        document.getElementById('divLeft_CELinks').style.display = "none";
        document.getElementById('divLeft_ALinks').style.display = "block";
        document.getElementById('divRight').style.display = "Default description for Assignments Link";
        document.getElementById('ls_Heading').innerHTML = "Assignments";
        document.getElementById('rs_Heading').innerHTML = "Assignment Brief";
